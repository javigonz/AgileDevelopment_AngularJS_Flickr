...
angular
    .module('flickrApp.directive',['$route', '$anchorScroll', '$compile', '$controller'])
    .directive('AnimateProvider', AnimateProvider);

    function AnimateProvider($route, $anchorScroll, $compile, $controller){
